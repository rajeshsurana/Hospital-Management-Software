...
public class medicineDel extends JFrame implements FocusListener,ActionListener,ItemListener 
{
	...
	public void read()
	{
		try
		{
			medicine1.mid=Integer.parseInt(tmid.getText());
			medicine1.mnm=tmnm.getText();
			medicine1.mnf=tmnf.getText();
			medicine1.prc=tprc.getText();
			medicine1.tp=cbg.getSelectedCheckbox().getLabel();
			medicine1.qty=Integer.parseInt(tqty.getText());
		}
		catch (Exception e)
		{
		}
	...
	public void focusLost(FocusEvent e)
	{
		...
		if(t==tmid)
		{
			...
			if(res)
			{
				...
				try
				{
					no=medicine1.rs.getInt(1);
					mn=medicine1.rs.getString(2);
					mnf=medicine1.rs.getString(3);
					prc=medicine1.rs.getString(5);
					tp=medicine1.rs.getString(4);
					qty=""+medicine1.rs.getInt(6);
				}
				catch (Exception e2)
				{
				}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(b==bd)
		{
			try
			{
				read();
				medicine1.del();
				JOptionPane.showMessageDialog(null,"Medicine ID: "+medicine1.mid+"  Record Deleted");
			}
			catch (Exception e6)
			{
			}
