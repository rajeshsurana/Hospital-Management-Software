...
public class medicineAdd extends JFrame implements FocusListener,ActionListener,ItemListener 
{
	...
	public void read()
	{
		try
		{
			medicine.mid=Integer.parseInt(tmid.getText());
			medicine.mnm=tmnm.getText();
			medicine.mnf=tmnf.getText();
			medicine.prc=tprc.getText();
			medicine.tp=cbg.getSelectedCheckbox().getLabel();
			medicine.qty=Integer.parseInt(tqty.getText());
		}
		catch (Exception e)
		{
		}
	...
	public void focusLost(FocusEvent e)
	{
		...
		if(t==tmid)
		{
			...
			if(res)
			{
				...
				try
				{
					no=medicine.rs.getInt(1);
					mn=medicine.rs.getString(2);
					mnf=medicine.rs.getString(3);
					prc=medicine.rs.getString(5);
					tp=medicine.rs.getString(4);
					qty=""+medicine.rs.getInt(6);
				}
				catch (Exception e2)
				{
				}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(b==ba)
		{
			try
			{
				read();
				medicine.add();
				JOptionPane.showMessageDialog(null,"Medicine ID: "+medicine.mid+"  Record Added");
			}
			catch (Exception e4)
			{
			}
