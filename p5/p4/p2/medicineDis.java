...
class disptable1 extends JFrame implements ActionListener
{
	JTable jt;
	JButton btn;
...
public class medicineDis extends JFrame implements FocusListener,ActionListener,ItemListener 
{
	...
	public void read()
	{
		try
		{
			medicine4.mid=Integer.parseInt(tmid.getText());
			medicine4.mnm=tmnm.getText();
			medicine4.mnf=tmnf.getText();
			medicine4.prc=tprc.getText();
			medicine4.tp=cbg.getSelectedCheckbox().getLabel();
			medicine4.qty=Integer.parseInt(tqty.getText());
		}
		catch (Exception e)
		{
		}
	...
	public void focusLost(FocusEvent e)
	{
		...
		if(t==tmid)
		{
			...
			if(res)
			{
				...
				try
				{
					no=medicine4.rs.getInt(1);
					mn=medicine4.rs.getString(2);
					mnf=medicine4.rs.getString(3);
					prc=medicine4.rs.getString(5);
					tp=medicine4.rs.getString(4);
					qty=""+medicine4.rs.getInt(6);
				}
				catch (Exception e2)
				{
				}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(b==bl)
		{
			disptable1 obj=null;
				try
				{
					obj=new disptable1(medicine4.collectRows1());
				}
