...
public class doctorDel extends JFrame implements FocusListener,ActionListener,ItemListener 
{
	...
	public doctorDel(String s)
	{
		...
		tdadd=new TextArea(doctor1.dadd);
	...
	public void read()
	{
		try
		{
			doctor1.did=Integer.parseInt(tdid.getText());
			doctor1.dfnm=tdfnm.getText();
			doctor1.dmnm=tdmnm.getText();
			doctor1.dlnm=tdlnm.getText();
			doctor1.gen=cbg.getSelectedCheckbox().getLabel();
			doctor1.dadd=tdadd.getText();
			//this.ad=tadd.getText();
			//System.out.println(tadd.getText());
			doctor1.cno=tcno.getText();
			//doctor1.jdt=tjdt.getText();
			doctor1.dqul=tdqul.getText();
			//System.out.println(tsym.getText());

			doctor1.ldt=tldt.getText();
			doctor1.sft=sft.getSelectedItem();
			doctor1.sts=sts.getSelectedItem();
			doctor1.path=str;
		}
		catch (Exception e)
		{
	...
	public void focusLost(FocusEvent e)
	{
		...
		if(t==tdid)
		{
			...
			if(res)
			{
				...
				try
				{
					no=doctor1.rs.getInt(1);
					dfn=doctor1.rs.getString(2);
					dmn=doctor1.rs.getString(3);
					dln=doctor1.rs.getString(4);
					gen=doctor1.rs.getString(5);
					dadd=doctor1.rs.getString(6);
					cno=doctor1.rs.getString(7);
					jdt=doctor1.rs.getString(8);
					dqul=doctor1.rs.getString(9);
					ldt=doctor1.rs.getString(10);
					sft=doctor1.rs.getString(11);
					sts=doctor1.rs.getString(12);
					dir=doctor1.rs.getString(14);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(b==bd)
		{
			try
			{
				read();
				doctor1.del();
				JOptionPane.showMessageDialog(null,"Doctor ID: "+doctor1.did+"  Record Deleted");
			}
			catch (Exception e6)
			{
			}
